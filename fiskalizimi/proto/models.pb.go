...
type CertificateDisabled struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	BusinessID    uint64                 `protobuf:"varint,1,opt,name=BusinessID,proto3" json:"BusinessID,omitempty"`
	PosID         uint64                 `protobuf:"varint,2,opt,name=PosID,proto3" json:"PosID,omitempty"`
	Message       string                 `protobuf:"bytes,3,opt,name=Message,proto3" json:"Message,omitempty"`
	DisabledAt    int64                  `protobuf:"varint,4,opt,name=DisabledAt,proto3" json:"DisabledAt,omitempty"`
...
func (x *CertificateEnabled) GetDisabledAt() int64 {
	if x != nil {
		return x.DisabledAt
	}
	return 0
...
type CouponValidated struct {
	...
	CouponID      uint64                 `protobuf:"varint,2,opt,name=CouponID,proto3" json:"CouponID,omitempty"`
	PosID         uint64                 `protobuf:"varint,3,opt,name=PosID,proto3" json:"PosID,omitempty"`
	CitizenID     uint64                 `protobuf:"varint,4,opt,name=CitizenID,proto3" json:"CitizenID,omitempty"`
	Status        string                 `protobuf:"bytes,5,opt,name=Status,proto3" json:"Status,omitempty"`
	ValidatedAt   int64                  `protobuf:"varint,6,opt,name=ValidatedAt,proto3" json:"ValidatedAt,omitempty"`
	Timestamp     int64                  `protobuf:"varint,7,opt,name=Timestamp,proto3" json:"Timestamp,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_models_proto_rawDesc = "" +
	...
	"\bTotalTax\x18\x03 \x01(\x03R\bTotalTax\"\xae\x04\n" +
	"\tPosCoupon\x12\x1e\n" +
	"\n" +
	...
	"TotalNoTax\x12 \n" +
	"\vReferenceNo\x18\x11 \x01(\x04R\vReferenceNo\"\xa1\x02\n" +
	"\rCitizenCoupon\x12\x1e\n" +
	"\n" +
	"BusinessId\x18\x01 \x01(\x04R\n" +
	"BusinessId\x12\x1a\n" +
	"\bCouponId\x18\x02 \x01(\x04R\bCouponId\x12\x14\n" +
	"\x05PosId\x18\x03 \x01(\x04R\x05PosId\x12&\n" +
	"\x0eVerificationNo\x18\x04 \x01(\x04R\x0eVerificationNo\x12#\n" +
	...
	"\bTotalTax\x18\t \x01(\x03R\bTotalTax\"\xf4\x01\n" +
	"\bQrCoupon\x12\x1e\n" +
	"\n" +
	"BusinessId\x18\x01 \x01(\x04R\n" +
	"BusinessId\x12\x1a\n" +
	"\bCouponId\x18\x02 \x01(\x04R\bCouponId\x12\x14\n" +
	"\x05PosId\x18\x03 \x01(\x04R\x05PosId\x12#\n" +
	"\x04Type\x18\x04 \x01(\x0e2\x0f.atk.CouponTypeR\x04Type\x12\x12\n" +
	"\x04Time\x18\x05 \x01(\x03R\x04Time\x12\x14\n" +
	"\x05Total\x18\x06 \x01(\x03R\x05Total\x12+\n" +
	"\tTaxGroups\x18\a \x03(\v2\r.atk.TaxGroupR\tTaxGroups\x12\x1a\n" +
	"\bTotalTax\x18\b \x01(\x03R\bTotalTax\"\xf1\x01\n" +
	...
	"\vCertificate\x18\x06 \x01(\tR\vCertificate\x12\x1c\n" +
	"\tTimestamp\x18\a \x01(\x03R\tTimestamp\"\xa3\x01\n" +
	"\x13CertificateDisabled\x12\x1e\n" +
	"\n" +
	"BusinessID\x18\x01 \x01(\x04R\n" +
	"BusinessID\x12\x14\n" +
	"\x05PosID\x18\x02 \x01(\x04R\x05PosID\x12\x18\n" +
	"\aMessage\x18\x03 \x01(\tR\aMessage\x12\x1e\n" +
	"\n" +
	"DisabledAt\x18\x04 \x01(\x03R\n" +
	"DisabledAt\x12\x1c\n" +
	...
	"BusinessID\x18\x02 \x01(\x04R\n" +
	"BusinessID\x12\x1a\n" +
	"\bCouponID\x18\x03 \x01(\x04R\bCouponID\x12\x14\n" +
	"\x05PosID\x18\x04 \x01(\x04R\x05PosID\x12#\n" +
	"\x04Type\x18\x05 \x01(\x0e2\x0f.atk.CouponTypeR\x04Type\x12\x12\n" +
	"\x04Time\x18\x06 \x01(\x03R\x04Time\x12+\n" +
	"\tTaxGroups\x18\a \x03(\v2\r.atk.TaxGroupR\tTaxGroups\x12\x1a\n" +
	"\bTotalTax\x18\b \x01(\x03R\bTotalTax\x12\x14\n" +
	"\x05Total\x18\t \x01(\x03R\x05Total\x12\x1c\n" +
	"\tTimestamp\x18\n" +
	" \x01(\x03R\tTimestamp\"\xab\x01\n" +
	...
	"\tTimestamp\x18\x06 \x01(\x03R\tTimestamp\"\xd9\x01\n" +
	"\x0fCouponValidated\x12\x1e\n" +
	"\n" +
	"BusinessID\x18\x01 \x01(\x04R\n" +
	"BusinessID\x12\x1a\n" +
	"\bCouponID\x18\x02 \x01(\x04R\bCouponID\x12\x14\n" +
	"\x05PosID\x18\x03 \x01(\x04R\x05PosID\x12\x1c\n" +
	"\tCitizenID\x18\x04 \x01(\x04R\tCitizenID\x12\x16\n" +
	"\x06Status\x18\x05 \x01(\tR\x06Status\x12 \n" +
	"\vValidatedAt\x18\x06 \x01(\x03R\vValidatedAt\x12\x1c\n" +
	"\tTimestamp\x18\a \x01(\x03R\tTimestamp\"\x80\x05\n" +
...
var file_models_proto_depIdxs = []int32{
	...
	0,  // 11: atk.PosFiscalCouponReceived.Type:type_name -> atk.CouponType
	2,  // 12: atk.PosFiscalCouponReceived.Items:type_name -> atk.CouponItem
	3,  // 13: atk.PosFiscalCouponReceived.Payments:type_name -> atk.Payment
	4,  // 14: atk.PosFiscalCouponReceived.TaxGroups:type_name -> atk.TaxGroup
