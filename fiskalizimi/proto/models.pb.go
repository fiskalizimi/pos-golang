...
type CitizenCoupon struct {
	...
	VerificationNo string                 `protobuf:"bytes,5,opt,name=VerificationNo,proto3" json:"VerificationNo,omitempty"`
...
func (x *CitizenCoupon) GetVerificationNo() string {
	if x != nil {
		return x.VerificationNo
	}
	return ""
...
const file_models_proto_rawDesc = "" +
	...
	"\x0eVerificationNo\x18\x05 \x01(\tR\x0eVerificationNo\x12#\n" +
